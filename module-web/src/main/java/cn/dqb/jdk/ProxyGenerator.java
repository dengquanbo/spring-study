...
//  }
     ...
     *
     * Note that new entries cannot be created after the constant pool has been written to a class file.  To prevent
     * such logic errors, a ConstantPool instance can be marked "read only", so that further attempts to add new entries
    ...
    private class ProxyMethod {
        ...
        /**
         * Generate code for initializing the static field that stores the Method object for this proxy method.  The
         * code is written to the supplied stream.
         */
